...
let website2: [String: String] = ["url": "www.yahoo.com", "label": "Yahoo", "value": "yahoo"]
...
class NavigationTest: BaseTestCase {
    ...
    func testNavigation() {
        ...
        navigator.openURL(urlString:  website2["url"]!)
        waitForValueContains(app.textFields["url"], value: website2["value"]!)
        XCTAssertTrue(app.buttons["TabToolbar.backButton"].isEnabled)
        XCTAssertFalse(app.buttons["TabToolbar.forwardButton"].isEnabled)
